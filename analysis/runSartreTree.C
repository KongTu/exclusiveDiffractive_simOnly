...
void runSartreTree(double fractionOfEventsToRead = 1, TString vm_name="jpsi", int PID_=0, double setLowPt_=0.1, bool smear_=false)
{
    ...
    //
    TH1D *hist_t_coherent = new TH1D("hist_t_coherent", "coherent", 100, 0, 0.2);
    TH1D *hist_t_incoherent = new TH1D("hist_t_incoherent", "incoherent", 100, 0, 0.2);
    TH1D *hist_t_afterPhaseSpace_coherent = new TH1D("hist_t_afterPhaseSpace_coherent", "coherent", 100, 0, 0.2);
    TH1D *hist_t_afterPhaseSpace_incoherent = new TH1D("hist_t_afterPhaseSpace_incoherent", "incoherent", 100, 0, 0.2);
